...
def start_walk(request):
    ...
    if serializer.is_valid():
        ...
        return Response({"message": "successfully", "data": response_data}, status=status.HTTP_200_OK)
...
def end_walk(request, walk_id):
    try:
        ...
        return Response({"message": "Walk history not found."}, status=status.HTTP_404_NOT_FOUND)
